...
while(T){
  ...
  maxx = abs(h)+r1
  maxy = abs(k)+r2
  if(maxx<11 && maxy<11 && r1>1 && r2>1){break}
}
...
If you find the square roots of both denominators, you will have the standard form of an ellipse. Notice $\sqrt{`r r1^2`}=`r r1`$ and $\sqrt{`r r2^2`}=`r r2`$.
