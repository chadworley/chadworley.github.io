...
for i in range(3,1000):
    ...
    pag.click(add_q_pos)
    pag.click(qt_pos)
    pag.typewrite('Which frieze group?',interval=0)
    # pag.click(MC_to_type_pos)
    # pag.click(TA_pos)
    time.sleep(0.1)
    pag.click(A1)
    time.sleep(0.1)
    pag.typewrite(a1,interval=0)
    time.sleep(0.1)
    pag.click(A2)
    time.sleep(0.1)
    pag.typewrite(a2,interval=0)
    time.sleep(0.1)
    pag.click(A3)
    time.sleep(0.1)
    pag.typewrite(a3,interval=0)
    time.sleep(0.1)
    pag.click(A4)
    time.sleep(0.1)
    pag.typewrite(a4,interval=0)
    time.sleep(0.1)
    pag.click(Ac[ans-1])
    time.sleep(0.1)
    pag.click(Image_pos)
