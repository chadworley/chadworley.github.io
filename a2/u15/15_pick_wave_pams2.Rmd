...
# I didnt change f to P in the code...
while(T){
...
The only calculation needed is to convert the period ($P=`r f`$) into [angular frequency](https://en.wikipedia.org/wiki/Angular_frequency) ($B$) by dividing $2\pi$ by the period.
$$B=\frac{2\pi}{P}$$
$$B=`r 2*pi/f`$$
