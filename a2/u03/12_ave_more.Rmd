...
That spinner ($X$) will be fairly spun `r n` times, and the **sample mean** of the spins will be recorded. Determine the probability that the random sample mean is more than `r xa`.
...
[video](https://vimeo.com/531941288){target="_blank"}
