...
That spinner ($X$) will be fairly spun `r n` times, and the **sample mean** ($\bar{X}$) of the spins will be recorded. Determine the probability that the random sample mean is less than `r xa`.
