...
* To find the probability that $X$ is between 90 and 110, we find the area between 90 and 110.
...
# Tools for finding normal areas

* In a spreadsheet: `=NORM.DIST`
* My [online tool](https://chadworley.github.io/a2/tools/normal.html).
* [Desmos](https://www.desmos.com/calculator) with expression NORMALDIST() and `Find Cumulative Probability`.
