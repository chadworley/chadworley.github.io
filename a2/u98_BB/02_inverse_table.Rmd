...
Create the [inverse function's](https://en.wikipedia.org/wiki/Inverse_function){target="_blank"} table. *Your answers here:*
...
============
extype: cloze
exclozetype: `r paste0(rep("schoice",length(x)+length(p2ord)),collapse="|")`
exsolution: `r paste0(ans,collapse="|")`|`r paste0(p2ans[p2ord],collapse="|")`
