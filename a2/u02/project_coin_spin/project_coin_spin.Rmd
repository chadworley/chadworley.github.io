...
11. Also, calculate a margin of error using $2\cdot\frac{\sqrt{0.5\cdot(1-0.5)}}{\sqrt{200}}$. Document this "formula" and its decimal approximation. Compare it to the margin of error from the simulation. This formula comes from less robust methods developed before computers.
