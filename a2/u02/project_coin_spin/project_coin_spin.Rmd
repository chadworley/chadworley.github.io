...
[https://chadworley.github.io/a2/u02/project_coin_spin/project_coin_spin.html](https://chadworley.github.io/a2/u02/project_coin_spin/project_coin_spin.html)
...
* Simulate 1000 repetitions of `r n` spins, assuming $P(\mathrm{heads})=0.5$ (our [null hypothesis](https://en.wikipedia.org/wiki/Null_hypothesis)). In each repetition, find the proportion of heads. Using all the repetitions, get a margin of error for proportion of heads.
...
* **Eventually**, your report should have the following sections:
    ...
    * Simulation
        ...
        * Give a link to your simulation spreadsheet.
...
12. Enter your spins (and coin data) onto our [google form](https://docs.google.com/forms/d/e/1FAIpQLSdG_HX7rZdUa2xWwHYhvYFyTWdIX1cc96Tn_EvaMCuCqcvLZg/viewform?usp=sf_link). You might need to submit multiple forms to help the class get to `r n` spins.
13. Once the class has `r n` spins, you can view [the results](https://docs.google.com/spreadsheets/d/1tQe_KXYcLMPUujmhEXb0yZLVSZyaEa_hjwoxx3716cQ/edit?usp=sharing).
...
19. Hand in your report on Canvas. 
