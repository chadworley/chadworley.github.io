...
library(latex2exp)
cat("\\color{red}")
cat("Ignore any negatives and the quadrant, and draw a right triangle in standard (quadrant I) orientation.\n\n")
par(mar=c(0,0,0,0))
...
cat(stp2)
cat("\n")
cat(paste0("Rescale the triangle so the hypotenuse is 1 to use the hypotenuse as a radius on the unit circle. Also reflect the triangle into Quadrant ",rmn[Q],"."))
cat("\\color{black}\n\n")
par(mar=c(0,0,0,0))
