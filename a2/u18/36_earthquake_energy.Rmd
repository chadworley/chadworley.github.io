...
Simplify. Remember, multiplication is [associative](https://en.wikipedia.org/wiki/Associative_property).


$$`r 3/2*(M+3.2)`~=~\frac{3}{2}\cdot \frac{2}{3}\cdot \log_{10}(E)$$

The product of two [reciprocals](https://en.wikipedia.org/wiki/Multiplicative_inverse) is 1. And 1 is the [identity element](https://en.wikipedia.org/wiki/Identity_element#Definitions) of multiplication.
