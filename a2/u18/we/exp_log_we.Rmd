...
1. Graph $`r exs[ord[1]]`$ and $`r exs[ord[2]]`$ on the grids below. Also, draw any asymptotes with dotted lines.
...
2. Write (but do not evaluate) the solution to the equation below by writing a logarithmic expression.
...
while(T){
    ...
    r = log(b)
    if(abs(a)>0.01 && abs(b)>0.01 && abs(a)<1000 && abs(b)<1000){break}
}
...
b. Express $f^{-1}(x)$, the inverse of $f$.
