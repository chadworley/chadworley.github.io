...
A right triangle has an angle measure $\theta$. The opposite leg's length is `r opp2` meters, and the hypotenuse's length is `r hypt` meters. What is the angle measure $\theta$ in radians?
...
Please round your answer to the hundredth of a radian.
...
Depending on your calculator, you might type something like ``round(arcsin(`r opp2`/`r hypt`),2)``
