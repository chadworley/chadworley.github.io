...
avt = "2025-05-14 7:00:00"
dut = "2025-05-19 22:59:00"
...
A = datetime.strptime(avt,"%Y-%m-%d %H:%M:%S")
D = datetime.strptime(dut,"%Y-%m-%d %H:%M:%S")
A = A+timedelta(hours=tdel)
D = D+timedelta(hours=tdel)
A = A.strftime("%Y-%m-%dT%H:%M:%SZ")
D = D.strftime("%Y-%m-%dT%H:%M:%SZ")
set_quiz_ass(name,A,D,"This is an independent mastery assignment.")
