...
s7 = paste("$\\mathbb{P}[\\text{",cs[c7]," given ",is[i7[1]],"}] = ",p7[1],"$ and $\\mathbb{P}[\\text{",cs[c7]," given  ",is[i7[2]],"}] = ",p7[2],"$, so a ",big," is more likely to be ",cs[c7]," than a ",small," is.",sep="")
...
exname: Cards_probabilities_shuffled
