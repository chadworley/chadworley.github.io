...
Imagine a loan with a [principal](https://en.wikipedia.org/wiki/Debt#Principal) of $`r P` and an [interest rate](https://en.wikipedia.org/wiki/Annual_percentage_rate) of `r r*100`%. Based your chosen timeline, the bank determines you should pay $`r k` per month. We can simulate the loan (in [Desmos](https://www.desmos.com/calculator)) using a recursively defined function.
...
Find how much debt remains after `r i` months.
