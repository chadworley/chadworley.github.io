...
What is `r percentage`% more than `r total`?


Solution
========

For a "percent more" question, the scale factor is found by dividing the percentage number by 100 and then adding 1.
