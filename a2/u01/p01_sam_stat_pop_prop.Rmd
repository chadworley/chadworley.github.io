...
subtitle: "*S-IC.A.1: Understand statistics as a process for making inferences to be made about population parameters based on a random sample from that population.*"
output:
  slidy_presentation:
    theme: cerulean
---
...
*(Some people get confused because they think "population" means the population count, how many people live in a town. In Statistics, when we say "what is the population", we are not asking how many people live in a place.)*
...
| difference of samples' means | $\bar{x}_2-\bar{x}_1$ | "x bar 2 minus x bar 1" |
...
| difference of populations' means | $\mu_2-\mu_1$ | "mu 2 minus mu 1" |
...
[https://chadworley.github.io/a2/u01/u01_shared1.html#Q1v1](https://chadworley.github.io/a2/u01/u01_shared1.html#Q1v1)
