...
* Sort column `r l4`.
* In an empty cell, type ``=`r l4`26``. In another empty cell, type ``=`r l4`975``. These are the boundaries of the 95%  confidence interval.
