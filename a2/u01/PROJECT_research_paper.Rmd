...
* You need to **generate the data**. I recommend using surveys (google forms), biological measurements (weights of pinecones), dexterity-based challenges (free throws), or videogames.
