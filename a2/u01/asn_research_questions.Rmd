...
* In statistics, the word "proportion" is used to mean a "percentage", but without a percent symbol. So, instead of a percentage of $42\%$, the proportion is $0.42$. It is best to think of a long list of yes/no responses. To find the proportion, you divide the count of yeses by the count of responses. Notice, if yes=1 and no=0, then the proportion is just an average of a list of 1s and 0s.

* The "mean" is the "average". You add up a bunch of measurements and divide by the count of the measurements. The measurements should be quantifiable: length, weight, time, count, density, energy, power, voltage, resistance, brightness, temperature, velocity, hue, pressure, frequency, etc...
