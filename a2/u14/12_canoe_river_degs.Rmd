...
al2 = paste0("* ",sprintf("%d°",ach2),collapse="\n")
...
A canoe travels `r sprintf("%.01f",vc)` m/s **relative to the water**. A river, heading east, flows at `r sprintf("%.01f",vr)` m/s. The canoe points at a direction `r sprintf("%d",deg)`° counterclockwise from east.
...
Find the canoe's total speed, in m/s, and direction of travel, as degrees counterclockwise from east.
...
So the speed of the canoe is `r rt` m/s at a direction of `r degt`° counterclockwise from east.
