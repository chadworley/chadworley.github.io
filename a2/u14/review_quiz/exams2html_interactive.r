...
outdir = "./"
genname = "trig_review"
probs = list("01_radians_from_arc_length.Rmd",
             "02_plot_angle_rads.Rmd",
             "03_1_sin_get_opp.Rmd","03_2_sin_get_hyp.Rmd",
