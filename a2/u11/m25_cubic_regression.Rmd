...
Run a cubic regression on the following points:
...
The result of the regression will be a cubic polynomial, which we can call $f$. Evaluate $f(`r xf`)$. The tolerance is $\pm0.01$.
...
If you copy/paste the table of points into a Desmos item, it should create a table. If not, add a new table and add the points shown above.
