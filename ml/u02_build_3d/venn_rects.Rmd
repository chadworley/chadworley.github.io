...
while(T){
    ...
    if(length(unique(aaa))==7 && min(aaa)>0 && !(x1+w1/2==x2+w2/2 && y1+h1/2==y2+h2/2)){break}
}
...
* Area covered by A = ##ANSWER1##
* Area covered by B = ##ANSWER2##
* Area covered by the intersection of A and B = ##ANSWER3##
* Area covered by the union of A and B = ##ANSWER4##
* Area covered by ONLY A (and not B) = ##ANSWER5##
* Area covered by ONLY B (and not A) = ##ANSWER6##
* Area not covered (neither A nor B) = ##ANSWER7##
