...
A wrap-around L-shaped patio will measure `r y` feet along both walls. The patio will stick out $x$ feet from the walls, and the total area will be `r x^2+2*x*y` square feet. *Note: you can assume all angles are right angles.*
...
We can now use the square-root operation on both sides of the equation.

$$\sqrt{(x+`r y`)^2}~=~\sqrt{`r area+y^2`}$$
