...
A wrap-around L-shaped patio will measure `r y` feet along each wall. The patio will stick out $x$ feet from the walls, and the total area will be `r x^2+2*x*y` square feet. *Note: you can assume all angles are right angles.*
...
text(1-y/N/2,1-x/N,paste0(y," ft"),cex=1.3,col=col2,adj=c(0.5,1.2))
text(x/N,(y/N/2),paste0(y," ft"),cex=1.3,col=col2,srt=90,adj=c(0.5,1.2))
