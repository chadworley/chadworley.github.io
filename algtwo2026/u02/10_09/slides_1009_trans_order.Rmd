...
* [ET_1009](https://bart.instructure.com/courses/2110/quizzes/3227)
* Slides_1009
* [OCW_1009_describe_transform](https://bart.instructure.com/courses/2110/quizzes/3228)
* [Blooket_1009](https://bart.instructure.com/courses/2110/assignments/29049)
...
Find the coordinate transformations. Start by writing down the given equation.
...
Notice... shift then stretch is different than stretch than shift.

For example, start at point $(4,5)$.

### Horizontal stretch by factor 2 followed by shift right by distance 3

* If we horizontally stretch by factor 2, we get $(8,5)$.
* If we shift $(8,5)$ to the right by 3, we get $(11,5)$

### Shift right by distance 3 followed by horizontal stretch by factor 2

* If we shift $(4,5)$ to the right by 3, we get $(7,5)$.
* If we horizontally stretch $(7,5)$ by factor 2 we get $(14,5)$
