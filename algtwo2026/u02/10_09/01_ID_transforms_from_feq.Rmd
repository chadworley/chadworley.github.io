...
That curve can be interpreted as a transformation of the parent curve $y=f[x]$. What transformations, and in what order, would produce the daughter curve from the parent curve?
...
It is easiest to see this by following our strategy. First, set the argument equal to $a$.
