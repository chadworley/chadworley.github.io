...
for(i in 1:4){
    ...
    for(i in -lim:lim){
        lines(c(-lim,lim),c(i,i),col="black",lwd=0.2)
        lines(c(i,i),c(-lim,lim),col="black",lwd=0.2)
    }
    for(i in seq(-lim,lim,5)){
        lines(c(-lim,lim),c(i,i),col="black",lwd=0.8)
        lines(c(i,i),c(-lim,lim),col="black",lwd=0.8)
    }
    abline(h=0,lwd=1.5)
    abline(v=0,lwd=1.5)
