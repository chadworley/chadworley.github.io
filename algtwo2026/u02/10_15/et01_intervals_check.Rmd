...
Using [interval notation](https://en.wikipedia.org/wiki/Interval_(mathematics)#Notations_for_intervals), indicate the intervals described below. All but range indicate $x$ values, and range indicates $y$ values.

1. Where is the function positive?
* (##ANSWER1##, ##ANSWER2##)
2. Where is the function negative?
* (##ANSWER3##, ##ANSWER4##)
3. Where is the function increasing?
* (##ANSWER5##, ##ANSWER6##)
4. Where is the function decreasing?
* (##ANSWER7##, ##ANSWER8##)
