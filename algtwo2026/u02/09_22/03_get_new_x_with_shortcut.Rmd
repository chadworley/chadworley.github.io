...
* What is the value of $x_{\text{new}}$?


Solution
========

Use the shortcut, which tells us we can make a formula by inverting the argument expression. The argument expression says to `r argwd`, so the inverse must `r invwd`.
