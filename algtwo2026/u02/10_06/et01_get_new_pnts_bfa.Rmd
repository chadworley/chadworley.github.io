...
Solve the [two-step equation](https://www.khanacademy.org/math/7th-grade-illustrative-math/unit-6-expressions-equations-and-inequalities/x16db28654a9632d7:reasoning-about-solving-equations-part-1/a/two-step-equations-review).

$$x~=~`r invarg`$$

Because we set $`r argex`$ equal to $a$, we can substitute $`r argex`$ with $a$ in the main equation.
