...
We can see that $g$ is a translated version of $f$. Thus, we can find constants $a$ and $b$ such that $g(x)=f(x+a)+b$ for all values of $x$. Determine $a$ and $b$:


* $g(x)~=~ f\biggl(x$##ANSWER1##$\biggr)$##ANSWER2##
