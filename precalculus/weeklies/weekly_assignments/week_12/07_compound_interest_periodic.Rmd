...
For the final amount, you can ignore the [floor](https://en.wikipedia.org/wiki/Floor_and_ceiling_functions) function, as $nt$ is an integer. You can round to the nearest penny. (*Tolerance is $\pm 1$*)
