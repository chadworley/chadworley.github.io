...
P = round(runif(1,2,5)/4,1)*4
B = 2*pi/P
D = round(runif(1,0.1,4.9-A),1)*sample(c(-1,1),1)
h = round(runif(1,0.1,P-0.1),1)
C = h*B
```
...
Estimate the **leftward (back in time) shift** of the [sinusoidal](https://www.khanacademy.org/math/algebra2/x2ec2f6f830c9fb89:trig/x2ec2f6f830c9fb89:amp-mid-period/a/midline-amplitude-and-period-review) function graphed above.
...
abline(h=A+D,col="grey",lwd=2,lty=2)
abline(h=-A+D,col="grey",lwd=2,lty=2)

abline(h=D,col=rgb(0.1,0.1,0.1),lwd=2,lty=2)

points(-h,D,pch=19,col="red")
text(-h,D+0.3*sign(D),paste0("(",-h,", ",D,")"),cex=2,col="red")


```
\

The leftward shift is $`r h`$. 
