...
The [half-life](https://en.wikipedia.org/wiki/Half-life) of an exponentially decaying function is the amount of time it takes for the population to halve. 
...
What is the half-life of the exponential function graphed above? (The answer is an integer.)


Solution
========

The half-life is `r hl` minutes.
...
Every `r hl` minutes, the population halves again. 
