...
In Calculus, you will prove many rules of differentiation by referring to the limit definition of a derivative. However, in practice, you will refer to the [rules of differentiation](https://en.wikipedia.org/wiki/Differentiation_rules). You can also refer to [this pdf](https://chadworley.github.io/precalculus/030_derivative/reference/deriv_rules_lag.pdf).
