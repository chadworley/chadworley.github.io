...
Don't do this by hand. I'm hoping we can begin using Python with the [sympy](https://docs.sympy.org/latest/tutorials/intro-tutorial/intro.html) library to do algebra for us.

1. Go to [https://colab.research.google.com/](https://colab.research.google.com/). 
2. Make a new notebook. 
3. In a code cell, type the following:

```{r,echo=F,results='asis'}
s = '```python\nimport sympy as sp\n'
s = paste0(s,'sp.var("w x y z")  #these will be our algebraic variables\n')
...
s = paste0(s,"sp.solve([eq1,eq2,eq3,eq4],[w,x,y,z])\n```")
s = gsub("+-","-",s,fixed=T)
cat(s)
```
