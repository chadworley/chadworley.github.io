...
And, really, [SageMath](https://chadworley.github.io/sage.html) can do the entire partial-fraction decomposition by using [sympy](https://www.sympy.org/en/index.html)'s [apart](https://docs.sympy.org/latest/tutorials/intro-tutorial/simplification.html#apart) function.
...
s = paste0(s,"from sympy import apart\n")
s = paste0(s,"apart(exp)\n```")
s = gsub("+-","-",s,fixed=T)
cat(s)
```
