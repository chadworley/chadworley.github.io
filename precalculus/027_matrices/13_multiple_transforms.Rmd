...
* Horizontal stretch by factor $k$ (reflection if $k=-1$). $$\begin{bmatrix}k & 0 \\ 0 & 1\end{bmatrix}$$
* Vertical stretch by factor $k$  (reflection if $k=-1$). $$\begin{bmatrix}1 & 0 \\ 0 & k\end{bmatrix}$$
