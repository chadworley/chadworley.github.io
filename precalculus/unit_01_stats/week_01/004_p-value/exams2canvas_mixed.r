...
probs = c("01_hyptest_single_mean.Rmd",
          "02_hyptest_one_prop.Rmd",
          "03_hyptest_2_means_data.Rmd")
...
exams2html_mod <- function(file, n = 1L, nsamp = NULL, dir = ".", template = NULL,
                           name = NULL, quiet = TRUE, edir = NULL, tdir = NULL, sdir = NULL, verbose = FALSE,
                           question = "<h4>Question</h4>", solution = "<h4>Solution</h4><button onclick='shower.call(this)'>Show solution</button><div class='hider' style = 'display: none;'>",
