...
* It might help to see the 3rd and 4th iterations to the 3rd iteration is spaced.
...
* The + symbol means turn clockwise by 90°.
...
If we use `BB-BB--BB-BB---BB-BB--BB-BAC-CA--CA-BAC---CA-BAC--BB-BAC-CA----`:
...
for(i in 1:nchar(s)){
    ...
    text(-9,9,s,adj=c(0,0.5),col="grey",cex=0.8)
    text(-9,9,ss,adj=c(0,0.5),cex=0.8)
    x = xyd1[[4]]
    y = xyd1[[5]]
    d = xyd1[[6]]
